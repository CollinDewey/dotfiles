...
in
{
  ...
  nixpkgs.overlays = [ (
    self: super:
    {
      ...
      #p3x-onenote = super.p3x-onenote.overrideAttrs (old: rec {
      #  version = "2022.4.127";
      ...
      #    sha256 = "sha256-WY/BfKR/VofBqKZq339lMh0rieWHovLWBI9mbMAC+Rc=";
      #  };
      #});
      #aseprite = super.aseprite.overrideAttrs (old: rec {
      #  version = "1.2.34.1";
      #  src = super.fetchFromGitHub {
      #    owner = "aseprite";
      #    repo = "aseprite";
      #    rev = "v${version}";
      #    sha256 = "sha256-YkqL9ZeeZiWA0Fpk3CowX+pMEeiUd7KghKu+15H4zJI=";
      #  };
      #});
    } 
  ) ];
  ...
  # binfmt appimage-run (https://github.com/viperML/dotfiles/blob/d9b889fbc28edfde118c6c3214f8f31ef612b649/modules/nixos/ld.nix#L51-L56)
